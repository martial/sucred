...
void MPDManager::newMidiMessage(ofxMidiMessage& msg) {
    ...
    switch (msg.control) {
        ...
        case 35:
            Globals::get()->animatorManager->getAnimator(2)->bLoopPalyndrome = !Globals::get()->animatorManager->getAnimator(2)->bLoopPalyndrome;
			            ...
			            Globals::get()->gui->liveGui->palyndromOverBtn->setValue(!Globals::get()->gui->liveGui->palyndromOverBtn->getValue());
    ...
    switch (msg.pitch) {
        ...
        Globals::instance()->effectsManager->strobEffect->strobDmx = !Globals::instance()->effectsManager->strobEffect->strobDmx;
		Globals::get()->sceneManager->getScene(0)->setStrobDmx(Globals::instance()->effectsManager->strobEffect->strobDmx);
        if(Globals::instance()->effectsManager->strobEffect->strobDmx) {
            		Globals::get()->gui->liveGui->strobDmxBtn->setValue(true);


             Globals::get()->effectsManager->disableEffect(0);
        }
        else {
            		Globals::get()->gui->liveGui->strobDmxBtn->setValue(false);
            Globals::get()->effectsManager->disableEffect(0);
        }

...
public:
	...
	void enable (bool value) {
		...
		return;
		liveGui->setVisible(value);
		inspectorGui->setVisible(value);
		configGui->setVisible(value);
		editorGui->setVisible(value);
		editorInspectorGui->setVisible(value);
		animPickerGui->setVisible(value);
		colorPickerGui->setVisible(value);
